...
<!---->
<!-- ``` -->
<!-- % git clone git@github.com/kayleebeyene/dotfiles.git -->
<!-- % cd dotfiles -->
<!-- ``` -->
<!---->
...
After hearing all the hype on the internet, I've started using [Ghostty](https://ghostty.org/)!

🏼 ✍Blog Post Step-by-Step Guide: [How To Make Your Mac Termial Look Cute!!!😺](#)
...
[Aerospace setup](.config/aerospace/)

📹 Youtube Guide: [How To Setup And Use The Aerospace Tiling Window Manager On (#)
